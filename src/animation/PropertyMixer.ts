...
import { Composite } from './PropertyBinding';
...
class PropertyMixer {
    ...
    apply(accuIndex) {
        ...
        for (let i = stride, s = stride + stride; i !== s; ++i) {
    ...
    saveOriginalState() {
        ...
        for (let i = stride, o = originalValueOffset; i !== o; ++i) {
