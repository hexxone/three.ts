...
class WebGLMorphtargets {
	...
	update( object: Object3D, geometry: BufferGeometry, material: Material, program: WebGLProgram ) {
		...
		program.getUniforms().setValue( this._gl, 'morphTargetBaseInfluence', morphBaseInfluence );
