...
const AnimationUtils = {
	...
	convertArray: function( myArray, MyType, forceClone? ) {
		if ( ! myArray || // let 'undefined' and 'null' pass
			! forceClone && myArray.constructor === MyType ) return myArray;
	...
	flattenJSON: function( jsonKeys, times: any[], values: any[], valuePropertyName ) {
		let i = 1;
		let key = jsonKeys[ 0 ];
