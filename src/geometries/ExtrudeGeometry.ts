...
class ExtrudeGeometry extends BufferGeometry {
    ...
    constructor(shapes?: Shape[], options: ExtrudeGeometryParameters = {}) {
        ...
        function addShape(shape) {
            ...
            let bevelEnabled
                = options.bevelEnabled !== undefined
                    ? options.bevelEnabled
                    : true;
            let bevelThickness
                = options.bevelThickness !== undefined
            ...
            function scalePt2(pt, vec, size) {
                ...
                return vec.clone().multiplyScalar(size)
                    .add(pt);
            }
            ...
            function getBevelVec(inPt, inPrev, inNext) {
                ...
                if (Math.abs(collinear0) > Number.EPSILON) {
                    ...
                    const v_trans_lensq
                        = v_trans_x * v_trans_x + v_trans_y * v_trans_y;
            ...
            function sidewalls(contour, layeroffset) {
                ...
                while (--i >= 0) {
                    ...
                    for (
                        let s = 0, sl = steps + bevelSegments * 2;
                        s < sl;
                        s++
                    ) {
                        const slen1 = vlen * s;
...
export {
    ExtrudeGeometry, ExtrudeGeometry as ExtrudeBufferGeometry
};
