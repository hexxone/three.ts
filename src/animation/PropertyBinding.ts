...
export class PropertyBinding {
    ...
    /**
     *
     * @param {any} root unknown
     * @param {string} path e.g. name of animation
     * @param {ParsedPath} parsedPath kp
     * @returns {PropertyBinding | Composite} binding
     */
    static create(root, path: string, parsedPath: ParsedPath): PropertyBinding | Composite {
