...
class Color {
	...
	setStyle(style) {
		function handleAlpha(string) {
			...
			if (parseFloat(string) < 1) {
				console.warn(
					"Color: Alpha component of " + style + " will be ignored."
				);
			}
		}
	...
	fromBufferAttribute(
		...
		this.r = Number(attribute.getX(index));
		this.g = Number(attribute.getY(index));
		this.b = Number(attribute.getZ(index));
