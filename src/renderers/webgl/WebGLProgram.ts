...
class WebGLProgram {
    ...
    constructor(
        ...
        if (parameters.isRawShaderMaterial) {
            prefixVertex = [this.customDefines]
            ...
            prefixVertex = [
                ...
                parameters.useFog && parameters.fogExp2
                    ? '#define FOG_EXP2'
                    : '',
        ...
        this.vertexShader = replaceClippingPlaneNums(
            this.vertexShader,
            parameters
        );
        ...
        const fragmentGlsl
            = versionString + prefixFragment + this.fragmentShader;
