...
class WebGLBindingStates {
    ...
    initAttributes() {
        const { newAttributes } = this.currentState;
    ...
    enableAttributeAndDivisor(attribute: number, meshPerAttribute) {
        const { newAttributes } = this.currentState;
        const { enabledAttributes } = this.currentState;
        const { attributeDivisors } = this.currentState;
            ...
            if (programAttribute >= 0) {
                ...
                if (geometryAttribute !== undefined) {
                    ...
                    if (
                        ...
                        if (
                            data
                            && data instanceof InstancedInterleavedBuffer
                        ) {
                        ...
                        if (
                            geometryAttribute
                            instanceof InstancedBufferAttribute
                        ) {
                            this.enableAttributeAndDivisor(
                                programAttribute,
                    ...
                    const attribute = this._attributes.get(
